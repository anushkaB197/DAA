import java.util.*;
public class FractionalKnapsackA {
    public static double fractionalKnapsackA(double[] weights, double[] values, double capacity) {
    ...
    public static void main(String[] args) {
        ...
        double maxValue = fractionalKnapsackA(weights, values, capacity);
